            ...
            VStack {
                Button(action:
                    ...
                    else
                    {
                        ...
                        dataController.create_new_user(username:enteredUsername, password: enteredPassword, email: enteredEmail, firstName: enteredFirstName, lastName: enteredLastName)
